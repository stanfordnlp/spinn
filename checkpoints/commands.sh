...
# Use flag --expanded_eval_only mode to do eval-only runs/
...
THEANO_FLAGS=allow_gc=False,cuda.root=/usr/bin/cuda,warn_float64=warn,device=gpu0,floatX=float32 python -m python.models.fat_classifier $REMBED_FLAGS
