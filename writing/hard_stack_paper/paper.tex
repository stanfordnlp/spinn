...
\begin{axis}[xmin=0, ymin=0, xlabel=Batch size, ylabel=Feedforward time (sec),
  ...
  \addplot table [x={Batch size}, y=RNN, col sep=tab] {runtime.csv};
  \addlegendentry{RNN}
\end{axis}
\end{tikzpicture}
}
