...
\todo{[SB] Introduce attention here if appropriate.}
...
The paper is structured as follows: We first introduce the PINN, then demonstrate its application to the task of natural language inference. We then discuss applications of neural attention to the PINN. Finally, we present experimental results and discussion.
