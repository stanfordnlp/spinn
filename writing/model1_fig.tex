...
\scalebox{0.6}{
 ...
 \caption{The SPINN unrolled for two transitions during the processing of the sentence \word{the cat sat down}. `Tracking', `transition', and `composition' are neural network layers. Gray arrows indicate connections which are blocked by a gating function.}\label{fig:model:1d}
...
\end{subfigure}
\caption{\label{fig:m1-views}Two views of the SPINN.}
\end{figure*}
